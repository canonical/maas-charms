...
def test_charm_tracing_config(tracing_relation):
    ...
    assert span.resource.attributes["service.name"] == "maas-region-charm"
    assert span.resource.attributes["compose_service"] == "maas-region-charm"
    assert span.resource.attributes["charm_type"] == "MaasRegionCharm"
